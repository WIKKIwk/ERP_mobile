...
class AppTheme {
  ...
  static ThemeData light() {
    ...
    final colorScheme = ColorScheme.fromSeed(
      ...
      primary: const Color(0xFF3A4559),
      onPrimary: const Color(0xFFF8FAFF),
      primaryContainer: const Color(0xFFDCE3F9),
      onPrimaryContainer: const Color(0xFF24324A),
      secondary: const Color(0xFF5B6578),
      onSecondary: const Color(0xFFFFFFFF),
      secondaryContainer: const Color(0xFFE6EAF4),
      onSecondaryContainer: const Color(0xFF253041),
      tertiary: const Color(0xFFD5DCEC),
      onTertiary: const Color(0xFF2A3343),
      tertiaryContainer: const Color(0xFFE7ECF7),
      onTertiaryContainer: const Color(0xFF2A3343),
      surface: const Color(0xFFF7F8FC),
      onSurface: const Color(0xFF2A2F3A),
      surfaceDim: const Color(0xFFDFE3EB),
      surfaceBright: const Color(0xFFFFFFFF),
      surfaceContainerLowest: const Color(0xFFFFFFFF),
      surfaceContainerLow: const Color(0xFFF1F4FA),
      surfaceContainer: const Color(0xFFEBEFF6),
      surfaceContainerHigh: const Color(0xFFE4E9F1),
      surfaceContainerHighest: const Color(0xFFDDE3EC),
      outline: const Color(0xFF7B8595),
      outlineVariant: const Color(0xFFC6CCD7),
    );
    final textTheme = _textTheme(
